...
namespace NetSCADA6.Common.NSColorManger
{
    ...
    internal class ButtonEx : Button
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            _solidRect.X = 10;
            _solidRect.Y = 6;
            _solidRect.Height = (Height - 5)/2;
            _solidRect.Width = _solidRect.Height; 
            _solidBrush.Color = _Color;
            g.FillRectangle(_solidBrush, _solidRect);
            g.DrawRectangle(Pens.Black, _solidRect);
        ...
        Rectangle _solidRect = new Rectangle();
        SolidBrush _solidBrush = new SolidBrush(Color.Black);
