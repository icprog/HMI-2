...
namespace Toolbox
{
		...
		IToolboxService
	{
		...
		private ToolboxTabCollection m_ToolboxTabCollection = new ToolboxTabCollection();
		...
		public void InitializeToolbox()
		{
			...
			toolboxXmlManager.PopulateToolboxInfo();
		...
		internal ToolboxTabCollection Tabs
		{
			get
			{
		...
		#region delegage
		public delegate void SelectItemChangedDelegate(System.Drawing.Design.ToolboxItem item);
		public delegate void CreateToolboxItemDelegate();
		/// <summary>
		/// 工具箱选择项改变
		/// </summary>
		public event SelectItemChangedDelegate SelectItemChanged;
		/// <summary>
		/// 工具项创建
		/// </summary>
		public event CreateToolboxItemDelegate CreateToolboxItem;
		...
		private void CreateToolboxItemFunction()
		{
			if(CreateToolboxItem != null)
				CreateToolboxItem();
		}
		#endregion
		...
		public void ResetPointer()
		{
			...
			ListBox lbSender = m_toolsListBox;
			Rectangle lastSelectedBounds = lbSender.GetItemRectangle(0);
			try
			{
				lastSelectedBounds = lbSender.GetItemRectangle(selectedIndex);
