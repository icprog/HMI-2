namespace Toolbox {
    ...
    //  </history>
    [Serializable()]
    internal class ToolboxItemCollection : CollectionBase {
        ...
        ///  </summary>
        ///  <param name="value">
        ///       A array of <see cref="ToolboxItem"/> objects with which to intialize the collection
        ///  </param>
        ///  <remarks></remarks>
        ///  <history>
        ///      [dineshc] 3/26/2003  Created
        ...
        ///  <summary>
        ///  Copies the elements of an array to the end of the <see cref="ToolboxItemCollection"/>.
        ///  </summary>
        ///  <param name="value">
        ///    An array of type <see cref="ToolboxItem"/> containing the objects to add to the collection.
        ///  </param>
        ...
        ///  <summary>
        ///  Copies the <see cref="ToolboxItemCollection"/> values to a one-dimensional <see cref="System.Array"/> instance at the 
        ///    specified index.
        ///  </summary>
        ///  <param name="array">The one-dimensional <see cref="System.Array"/> that is the destination of the values copied from <see cref="ToolboxItemCollection"/> .</param>
        ///  <param name="index">The index in <paramref name="array"/> where copying begins.</param>
        ///  <remarks><exception cref="System.ArgumentException"><paramref name="array"/> is multidimensional. <para>-or-</para> <para>The number of elements in the <see cref="ToolboxItemCollection"/> is greater than the available space between <paramref name="arrayIndex"/> and the end of <paramref name="array"/>.</para></exception>
